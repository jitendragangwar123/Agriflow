   ...
   return (
       <>
                 ...
                 <div className = "mb-5 md:mx-40">
                   ...
                   <ul className = "text-gray-500">
                     <li className = "pb-2 flex">
                       ...
                       <span className = "hover:text-blue-400 cursor-pointer font-semibold duration-200">Agriflow</span>
                     </li>
                     <li className = "pb-2 flex">
                       <BiChevronRight className = "relative text-blue-400" size = {25} />
                       <a href = "/" target = "_blank" rel = "noreferrer" className = "hover:text-blue-400 cursor-pointer font-semibold duration-200">Blogs</a>
                     </li>
                     <li className = "pb-2 flex">
                       <BiChevronRight className = "relative text-blue-400" size = {25} />
         ...
         <div className = "bg-gray-600 text-gray-400 flex max-sm:flex-col justify-between items-center px-10 py-5 mb-auto font-semibold text-center">
           <div className = "text-base">© 2022-2023 Agriflow™. All Rights Reserved.</div>
