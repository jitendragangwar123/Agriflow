...
function Footer() {
   return (
       <>
         <div className = "bg-gray-800 p-8 text-gray-200">
           <div className = "max-w-15xl mx-auto">
             <div className = "flex gap-2 justify-between max-md:flex-col max-md:text-center">  
               <div className = "mb-5">
                 ...
                 <p className = "text-gray-500 pb-2">Join 1000+ others and never miss out our Latest Updates.</p>
                 ...
                 <div className = "mb-5 md:mx-40">
                   ...
                   <ul className = "text-gray-500">
                     <li className = "pb-2 flex">
                       ...
                       <span className = "hover:text-blue-400 cursor-pointer font-semibold duration-200">AgriMartX.eth</span>
                     </li>
                     <li className = "pb-2 flex">
                       <BiChevronRight className = "relative text-blue-400" size = {25} />
                       <a href = "/" target = "_blank" rel = "noreferrer" className = "hover:text-blue-400 cursor-pointer font-semibold duration-200">Blog</a>
                     </li>
                     <li className = "pb-2 flex">
                       <BiChevronRight className = "relative text-blue-400" size = {25} />
                       <a href = "/" target = "_blank" rel = "noreferrer" className = "hover:text-blue-400 cursor-pointer font-semibold duration-200">News</a>
                     </li>
                   </ul>
                 </div>
         ...
         <div className = "bg-gray-600 text-gray-400 flex max-sm:flex-col justify-between items-center px-10 py-1 font-semibold text-center">
           <div className = "text-base">© 2022-2023 AgriMartX.eth™. All Rights Reserved.</div>
