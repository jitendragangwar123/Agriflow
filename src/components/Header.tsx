 ...
 return (
   <header className="bg-green-500">
     <div className="container mx-auto flex items-center justify-between p-4">
       <h1 className="rounded-xl py-1 px-3 text-4xl font-bold text-complementary shadow-neutral [transition:color_.5s_ease-in-out,box-shadow_.5s_ease-in-out] hover:text-highlight-600 hover:bg-green-600">
         <Link href="/">AgriMart</Link>
       </h1>
