...
const AboutApp = () => {
  ...
  return (
    <>
      <div className="w-full py-14 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white">
        ...
        <div className="mx-auto flex flex-col-reverse items-center justify-center h-full px-4 md:px-8 my-3 md:flex-row z-10">
          <div>
